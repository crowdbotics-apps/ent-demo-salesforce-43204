...
## Project Structure
    ...
    ├── ent_demo_salesforce_43204  # Django project configurations
...
1. Clone this repo and `cd ent_demo_salesforce_43204`
...
2. Clone this repo and `cd ent_demo_salesforce_43204`
